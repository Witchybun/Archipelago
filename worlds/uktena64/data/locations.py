...
jeb_base_locations = [
    ...
    # create_location(5, JebCabin.clear, JebRegion.cabin),

    create_location(6, TurkeyCreek.turkey_call, JebRegion.turkey),
    create_location(7, TurkeyCreek.hen_ammo, JebRegion.turkey),
    create_location(8, TurkeyCreek.hen_coffee, JebRegion.turkey),
    create_location(9, TurkeyCreek.house_ammo, JebRegion.turkey),
    create_location(10, TurkeyCreek.dark_spot_ammo, JebRegion.turkey),
    create_location(11, TurkeyCreek.house_coffee, JebRegion.turkey),
    create_location(12, TurkeyCreek.rock_coffee, JebRegion.turkey),
    # create_location(13, TurkeyCreek.clear, JebRegion.turkey),

    create_location(14, FrigidValley.shack_ammo, JebRegion.frigid),
    create_location(15, FrigidValley.truck, JebRegion.frigid),
    create_location(16, FrigidValley.path_ammo, JebRegion.frigid),
    create_location(17, FrigidValley.second_ammo, JebRegion.frigid),
    create_location(18, FrigidValley.trailer_coffee, JebRegion.frigid),
    create_location(19, FrigidValley.trailer_ammo, JebRegion.frigid),
    create_location(20, FrigidValley.trailer_barrel_ammo, JebRegion.frigid),
    create_location(21, FrigidValley.trailer_tv_coffee, JebRegion.frigid),
    create_location(22, FrigidValley.final_shack_coffee, JebRegion.frigid),
    create_location(23, FrigidValley.final_shack_ammo, JebRegion.frigid),
    create_location(24, FrigidValley.late_path_ammo, JebRegion.frigid),
    # create_location(25, FrigidValley.clear, JebRegion.frigid),

    create_location(26, HowlingMarsh.revolver, JebRegion.howling),
    create_location(27, HowlingMarsh.house_coffee, JebRegion.howling),
    create_location(28, HowlingMarsh.house_ammo, JebRegion.howling),
    create_location(29, HowlingMarsh.fence_house_ammo_1, JebRegion.howling),
    create_location(30, HowlingMarsh.fence_house_ammo_2, JebRegion.howling),
    create_location(31, HowlingMarsh.church_key, JebRegion.howling),
    create_location(32, HowlingMarsh.graveyard_ammo, JebRegion.howling),
    create_location(33, HowlingMarsh.greenhouse_ammo_1, JebRegion.howling),
    create_location(34, HowlingMarsh.greenhouse_ammo_2, JebRegion.howling),
    create_location(35, HowlingMarsh.trailer_coffee, JebRegion.howling),
    # create_location(36, HowlingMarsh.clear, JebRegion.howling),

    create_location(37, BleedingGrove.bren, JebRegion.bleeding),
    # create_location(38, BleedingGrove.clear, JebRegion.howling),
]
...
jeb_lore_locations = [
    ...
    create_location(jeb_lore_code + 4, JebLore.starved_chickens, JebRegion.turkey),
    create_location(jeb_lore_code + 5, JebLore.newfound_god, JebRegion.turkey),
    create_location(jeb_lore_code + 6, JebLore.the_turkeys, JebRegion.turkey),
    create_location(jeb_lore_code + 7, JebLore.the_uktena_1, JebRegion.frigid),
    create_location(jeb_lore_code + 8, JebLore.the_uktena_2, JebRegion.frigid),
    create_location(jeb_lore_code + 9, JebLore.loud_sound, JebRegion.frigid),
    create_location(jeb_lore_code + 10, JebLore.ringing, JebRegion.frigid),
    create_location(jeb_lore_code + 11, JebLore.nightmare, JebRegion.frigid),
    create_location(jeb_lore_code + 12, JebLore.church_note, JebRegion.howling),
    create_location(jeb_lore_code + 13, JebLore.trailer_day_1, JebRegion.howling),
    create_location(jeb_lore_code + 14, JebLore.trailer_day_5, JebRegion.howling),
    create_location(jeb_lore_code + 15, JebLore.more_than_one, JebRegion.bleeding),
    create_location(jeb_lore_code + 16, JebLore.the_uktena_3, JebRegion.bleeding),
    create_location(jeb_lore_code + 17, JebLore.the_hunger, JebRegion.bleeding),
    create_location(jeb_lore_code + 18, JebLore.no_food, JebRegion.bleeding),
]
...
jeb_photo_locations = [
    ...
    create_location(jeb_photo_code + 6, TurkeyCamera.turkey_2, JebRegion.turkey, PhotoItem.turkey),
    create_location(jeb_photo_code + 7, TurkeyCamera.rock_linked_turkey_1, JebRegion.turkey, PhotoItem.turkey),
    create_location(jeb_photo_code + 8, TurkeyCamera.rock_linked_turkey_2, JebRegion.turkey, PhotoItem.turkey),
    create_location(jeb_photo_code + 9, TurkeyCamera.rock_linked_turkey_3, JebRegion.turkey, PhotoItem.turkey),
    create_location(jeb_photo_code + 10, TurkeyCamera.creek_dead_body, JebRegion.turkey, PhotoItem.turkey),
    create_location(jeb_photo_code + 11, TurkeyCamera.house_linked_turkey_1, JebRegion.turkey, PhotoItem.turkey),
    create_location(jeb_photo_code + 12, TurkeyCamera.house_linked_turkey_2, JebRegion.turkey, PhotoItem.turkey),
    create_location(jeb_photo_code + 13, TurkeyCamera.house_linked_turkey_3, JebRegion.turkey, PhotoItem.turkey),
    create_location(jeb_photo_code + 14, TurkeyCamera.turkey_3, JebRegion.turkey, PhotoItem.turkey),
    create_location(jeb_photo_code + 15, TurkeyCamera.headless_turkey, JebRegion.turkey, PhotoItem.turkey),

    create_location(jeb_photo_code + 16, FrigidCamera.early_wolf_1, JebRegion.frigid, PhotoItem.frigid_valley),
    create_location(jeb_photo_code + 17, FrigidCamera.early_wolf_2, JebRegion.frigid, PhotoItem.frigid_valley),
    create_location(jeb_photo_code + 18, FrigidCamera.early_wolf_3, JebRegion.frigid, PhotoItem.frigid_valley),
    create_location(jeb_photo_code + 19, FrigidCamera.second_wolf_1, JebRegion.frigid, PhotoItem.frigid_valley),
    create_location(jeb_photo_code + 20, FrigidCamera.second_wolf_2, JebRegion.frigid, PhotoItem.frigid_valley),
    create_location(jeb_photo_code + 21, FrigidCamera.second_wolf_3, JebRegion.frigid, PhotoItem.frigid_valley),
    create_location(jeb_photo_code + 22, FrigidCamera.second_wolf_4, JebRegion.frigid, PhotoItem.frigid_valley),
    create_location(jeb_photo_code + 23, FrigidCamera.open_wolf_1, JebRegion.frigid, PhotoItem.frigid_valley),
    create_location(jeb_photo_code + 24, FrigidCamera.open_wolf_2, JebRegion.frigid, PhotoItem.frigid_valley),
    create_location(jeb_photo_code + 25, FrigidCamera.circle_meat, JebRegion.frigid, PhotoItem.frigid_valley),
    create_location(jeb_photo_code + 26, FrigidCamera.trailer_dog, JebRegion.frigid, PhotoItem.frigid_valley),
    create_location(jeb_photo_code + 27, FrigidCamera.tree_dog_1, JebRegion.frigid, PhotoItem.frigid_valley),
    create_location(jeb_photo_code + 28, FrigidCamera.tree_dog_2, JebRegion.frigid, PhotoItem.frigid_valley),
    create_location(jeb_photo_code + 29, FrigidCamera.elk, JebRegion.frigid, PhotoItem.frigid_valley),
    create_location(jeb_photo_code + 30, FrigidCamera.skinned_return_1, JebRegion.frigid),
    create_location(jeb_photo_code + 31, FrigidCamera.skinned_return_2, JebRegion.frigid),
    create_location(jeb_photo_code + 32, FrigidCamera.skinned_return_3, JebRegion.frigid),
    create_location(jeb_photo_code + 33, FrigidCamera.skinned_return_4, JebRegion.frigid),
    create_location(jeb_photo_code + 34, FrigidCamera.skinned_return_5, JebRegion.frigid),
    create_location(jeb_photo_code + 35, FrigidCamera.skinned_return_6, JebRegion.frigid),
    create_location(jeb_photo_code + 36, FrigidCamera.skinned_return_7, JebRegion.frigid),
    create_location(jeb_photo_code + 37, FrigidCamera.snowman_skull, JebRegion.frigid),
...
jeeb_base_locations = [
    ...
    create_location(jeeb_base_code + 15, LakeLinger.boat_house_coffee, JeebRegion.lake),
    create_location(jeeb_base_code + 16, LakeLinger.island_coffee, JeebRegion.lake),
    create_location(jeeb_base_code + 17, LakeLinger.island_ammo, JeebRegion.lake),
    create_location(jeeb_base_code + 18, LakeLinger.dead_end_ammo, JeebRegion.lake),
    create_location(jeeb_base_code + 19, LakeLinger.two_story_coffee, JeebRegion.lake),
    create_location(jeeb_base_code + 20, LakeLinger.main_office_ammo, JeebRegion.lake),
    ...
    # create_location(jeeb_base_code + 33, LakeLinger.clear, JeebRegion.lake),

    create_location(jeeb_base_code + 34, PallidPark.chamber_ammo, JeebRegion.pallid),
    create_location(jeeb_base_code + 35, PallidPark.owner_ammo, JeebRegion.pallid),
    create_location(jeeb_base_code + 36, PallidPark.swamp_bridge_ammo, JeebRegion.pallid),
    create_location(jeeb_base_code + 37, PallidPark.crossbow, JeebRegion.pallid),
    create_location(jeeb_base_code + 38, PallidPark.north_coffee, JeebRegion.pallid),
    create_location(jeeb_base_code + 39, PallidPark.swamp_shack_ammo, JeebRegion.pallid),
    create_location(jeeb_base_code + 40, PallidPark.swamp_shack_bolts, JeebRegion.pallid),
    create_location(jeeb_base_code + 41, PallidPark.swamp_shack_coffee, JeebRegion.pallid),
    create_location(jeeb_base_code + 42, PallidPark.south_office_coffee, JeebRegion.pallid),
    create_location(jeeb_base_code + 43, PallidPark.south_office_ammo, JeebRegion.pallid),
    # create_location(jeeb_base_code + 44, PallidPark.clear, JeebRegion.pallid),

    create_location(jeeb_base_code + 45, BurningGrove.banjo, JeebRegion.burning),
    # create_location(jeeb_base_code + 46, BurningGrove.clear, JeebRegion.burning),
]
...
jeeb_lore_locations = [
    ...
    create_location(jeeb_lore_code + 3, JeebLore.tree, JeebRegion.ritual),
...
jeeb_meat_locations = [
    ...
    create_location(jeeb_meat_code + 40, LakeMeat.trapped_start_1),
    create_location(jeeb_meat_code + 41, LakeMeat.trapped_start_2),
    create_location(jeeb_meat_code + 42, LakeMeat.trapped_start_3),
    create_location(jeeb_meat_code + 43, LakeMeat.trapped_start_4),
