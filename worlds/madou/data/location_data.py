...
light_forest_locations = [
    ...
    create_location(light_forest_location_start + 3, ForestOfLight.sukiyapodes_2, MadouRegion.forest_of_light, 0x00139d, 0x10,
...
ancient_village_locations = [
    ...
    create_location(ancient_village_location_start + 2, AncientVillage.villager_2, MadouRegion.ancient_village, 0x0013a3, 0x08,
