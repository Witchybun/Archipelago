...
grass_locations = [
    ...
    create_location(LOCATION_CODE_START + grass_location_start + 167, GrassLocation.fla_lotus_15, LunacidRegion.temple_of_water_lower),
    ...
    create_location(LOCATION_CODE_START + grass_location_start + 180, GrassLocation.fla_lotus_18, LunacidRegion.temple_of_water_lower),
